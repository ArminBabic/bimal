      ...
      <div className="w-full max-w-[1200px]  flex flex-col items-center">
          ...
          <div className="w-[95%] max-w-[30rem] md:max-w-[340px] lg:max-w-[30rem] grow flex flex-col  mx-auto md:mx-0 2xl:mx-0  items-start gap-4  ">
            ...
            <div className="max-w-[30rem] text-sm xs:text-base md:text-sm lg:text-base ">
              <p className="leading-7">
                ...
                high-value investments, ranging from renewable energy projects
                to real estate developments and strategic acquisitions. We
                specialize in connecting international investors with premium
                opportunities across the region, providing seamless end-to-end
                support throughout the investment process.Whether it's energy,
                real estate, or corporate acquisitions, our team ensures that
                every transaction is handled with precision and professionalism.{" "}
              </p>
          ...
          <div className="w-[95%] max-w-[30rem] md:max-w-[340px] lg:max-w-[30rem] grow flex flex-col  mx-auto md:mx-0 2xl:mx-0  items-start  ">
            <div className="max-w-[30rem] text-sm xs:text-base md:text-sm lg:text-base leading-7">
              <p className="leading-7">
                ...
                investors, simplifying entry into new markets and ensuring they
        ...
        >
          ...
          <div className="w-[95%] max-w-[30rem] md:max-w-[340px] lg:max-w-[30rem] grow flex flex-col  mx-auto md:mx-0 2xl:mx-0  items-start  ">
            <div className="max-w-[30rem] text-sm xs:text-base md:text-sm lg:text-base">
              <p className="leading-7">
                Your trusted partner for successful investments in the Balkans,
                Project Pro is committed to turning opportunities into reality,
                whether through strategic energy projects, key real estate
                developments, or corporate acquisitions. We're always ready to
                assist in transforming your vision into lasting success. We are
                currently advising on approximately 1057 MW of renewable energy
                projects in collaboration with our external business partner—a
                law firm—some of which are listed below. Additionally, we have
                served as the primary advisors for over 400 MW of projects that
                have already been built and commissioned.
              </p>
              <div className=" mt-8 md:mt-7 lg:mt-4">
                <Link href={`tel:`} passHref>
                  <button
